...
def get_config():
    ...
    parser.add_argument('--num_log_iter', type=int, default=100,
    ...
    parser.add_argument('-strongAug', '--strongAug', type=bool, default=False, help='if use strongAug to replace weak for supervised')
